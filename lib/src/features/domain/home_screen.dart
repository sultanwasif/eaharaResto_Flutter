...
class _HomeScreenState extends State<HomeScreen> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("eAhara Restaurant", style : GoogleFonts.poppins( color: tDarkColor, fontWeight: FontWeight.w700),),
          leading: const Icon(Icons.restaurant_menu_outlined, color: tDarkColor,),
          actions: <Widget>[
          IconButton(
              onPressed: () {
               logout();
                ...
                children: [
                  FutureBuilder(
                    ...
                    builder: (BuildContext context, AsyncSnapshot<String> snapshot) =>
                        Text(
                          snapshot.hasData ? "Welcome ${snapshot.data}" : "", //+ '- DEV'
                              ...
                              child: InkWell(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                        Text('Total Orders', style: Theme.of(context).textTheme.titleSmall,),
                                        Text(_totalOrder.toString(), style: Theme.of(context).textTheme.titleLarge,)
                                      ]),
                                ),
                              )
                        ),
                                ...
                                child: InkWell(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          Text('New Orders', style: Theme.of(context).textTheme.titleSmall,),
                                          Text(_approvedOrder.toString(), style: Theme.of(context).textTheme.titleLarge,)
                                        ]),
                                  ),
                                )
                            ),
                                ...
                                child: InkWell(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          Text('Ready Orders', style: Theme.of(context).textTheme.titleSmall,),
                                          Text(_readyOrder.toString(), style: Theme.of(context).textTheme.titleLarge,)
                                        ]),
                                  ),
                                )
                            ),
                                ...
                                child: InkWell(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          Text('Picked Orders', style: Theme.of(context).textTheme.titleSmall,),
                                          Text(_pickedOrder.toString(), style: Theme.of(context).textTheme.titleLarge,)
                                        ]),
                                  ),
                                )
                            ),
                                ...
                                child: InkWell(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          Text('Cancel Orders', style: Theme.of(context).textTheme.titleSmall,),
                                          Text(_cancelOrder.toString(), style: Theme.of(context).textTheme.titleLarge,)
                                        ]),
                                  ),
                                )
                            ),
                                ...
                                child: InkWell(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          Text('Delivered Orders', style: Theme.of(context).textTheme.titleSmall,),
                                          Text(_deliveredOrder.toString(), style: Theme.of(context).textTheme.titleLarge,)
                                        ]),
                                  ),
                                )
                            ),
  ...
  Future<void> getShopDetails() async {
    ...
    http.Response response = await http
        .get(Uri.parse('${tBasePath}DashBoardCounts$tSlash$shopId'),
        headers: headers,);
